...
<c:import url="../import/l_header.jsp">
	...
	<script>
		$('#countdowner').scojs_countdown({until: 1558856054});
	</script>
	...
	<div class="container">
		...
		<form class="form-signin" action="<%=path%>/login/login.do" method="post">
			...
			<input style="margin-bottom: 10px;" type="text" id="inputUser" name="inputUser" class="form-control" placeholder="账户名" required autofocus>
