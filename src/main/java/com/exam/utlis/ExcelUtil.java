...
public class ExcelUtil {
     ...
     */
    public static <T extends BaseRowModel> List<T> readExcel(MultipartFile excel, Class<Student> rowModel) throws ExcelException {
        ...
        return (List<T>) getExtendsBeanList(excelListener.getDataList(),rowModel);
    }
    ...
    private static OutputStream getOutputStream(String fileName, HttpServletResponse response, ExcelTypeEnum excelTypeEnum) throws ExcelException{
        ...
        try {
           ...
           // response.addHeader("Content-Disposition", "filename=" + fileName);
            ...
            headerValue += " filename=\"" + encodeURIComponent(filePath) + "\";";
            headerValue += " filename*=utf-8''" + encodeURIComponent(filePath);
